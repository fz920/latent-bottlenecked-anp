...
# and the BNP (https://arxiv.org/abs/2008.02956) implementation
# from https://github.com/juho-lee/bnp by Juho Lee
####################################################################################
...
class CelebA(object):
    def __init__(self, train=True, resolution=32):
        self.data, self.targets = torch.load(
                osp.join(datasets_path, f'celeba{resolution}',
...
if __name__ == '__main__':
    ...
    torch.save([eval_imgs, eval_labels], osp.join(datasets_path, f'celeba{args.resolution}', 'eval.pt'))
